...
from gifts.common.tpg import (
    Parser, Error, LexicalError, SyntacticError, SemanticError,
    Lexer, NamedGroupLexer, CacheNamedGroupLexer, Token, EOFToken, WrongToken,
...
class TestLexerStartMethod:
    ...
    def test_named_group_lexer_start_clears_previous_state(self):
        ...
        # First parsing
        lexer.start("hello")
        max_pos_1 = lexer.max_pos
        
        # Second parsing with different input
        lexer.start("world")
        max_pos_2 = lexer.max_pos
